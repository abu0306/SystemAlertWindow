...
//        decoration:
//            SystemWindowDecoration(startColor: Colors.red, borderRadius: 25.0),
          rows: [
            EachRow(gravity: ContentGravity.CENTER, columns: [
              EachColumn(
                padding: SystemWindowPadding(top: 6),
...
//                  startColor: Colors.black12, borderRadius: 25.0),
              ...
              EachColumn(
                padding: SystemWindowPadding(bottom: 6),
                text: SystemWindowText(
                    text: "-16.75%",
                    fontSize: 11,
                    fontWeight: FontWeight.NORMAL,
...
//                  startColor: Colors.black12, borderRadius: 25.0),
            ...
            EachRow(last: true, gravity: ContentGravity.CENTER, columns: [
              EachColumn(
                padding: SystemWindowPadding(top: 6),
                text: SystemWindowText(
                    text: "BTCUSDT",
